...
function Products({ products, query }) {
  const productss = JSON.parse(products).filter(product => query ? product.title.includes((query.search).toUpperCase()) : product);
    ...
    <>
      ...
      <div className={classes.header_wrapper}>
        ...
        <form className={classes.header_searchBox}>
          <input type="text" placeholder="Tìm kiếm tên sản phẩm / danh mục ..." onSubmit={searchHandler}/>
        </form>
      </div>
