...
function Products({ products, query }) {
  ...
  const searchHandler = function(e) {
    e.preventDefault();
    router.push(`/products?search=${searchInput.valuevalue}`)
    searchInput.value = ''
  }
    ...
    <>
      ...
      <div className={classes.header_wrapper}>
        ...
        <form className={classes.header_searchBox} onSubmit={searchHandler}>
          <input id="searchInput" type="text" placeholder="Tìm kiếm tên sản phẩm / danh mục ..." onChange={(e) => setSearch(e.currentTarget.value)}/>
        </form>
      </div>
