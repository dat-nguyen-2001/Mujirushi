  ...
  return (
    <div>
        <div className={classes.card_wrapper}>
          ...
          <Card img="recommended-categories/skincare.webp" title="PHỤ KIỆN TRANG ĐIỂM" description ="Các sản phẩm dưỡng da của MUJI đều có thành phần chính là nước suối được lấy từ hang động ở Kamaishi, tỉnh Iwate, Nhật Bản."/>
